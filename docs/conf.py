...
latex_documents = [
    (master_doc, 'ccsdspy.tex', u'ccsds Documentation',
     u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ccsdspy', u'ccsdspy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ccsdspy', u'ccsdspy Documentation',
     author, 'ccsdspy', 'One line description of project.',
     'Miscellaneous'),
]
