...
def _parallel_target(key: str, mesh_fname: str, *args, **kwargs) -> Tuple[str, float]:
...
def _get_run_configuration(
    ...
    if args.file_set == "quiet":
        mesh_file_names = {
            "LFM": os.path.join(
                args.data_dir, "LFM-20131002_RBSP/ElkStorm_mhd_2013-10-04T00-00-00Z.hdf"
            ),
        ...
        mesh_file_names = {
            "LFM": os.path.join(
                args.data_dir, "LFM-20131002_RBSP/ElkStorm_mhd_2013-10-02T06-19-00Z.hdf"
            ),
            "LFM-RCM": os.path.join(
                args.data_dir,
